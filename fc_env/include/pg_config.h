...
#define CONFIGURE_ARGS " '--prefix=/Users/mac/dev/pet/FindCorr/fc_env' '--with-readline' '--with-libraries=/Users/mac/dev/pet/FindCorr/fc_env/lib' '--without-icu' '--with-includes=/Users/mac/dev/pet/FindCorr/fc_env/include' '--with-openssl' '--with-uuid=e2fs' '--with-libxml' '--with-libxslt' '--with-gssapi' '--with-system-tzdata=/Users/mac/dev/pet/FindCorr/fc_env/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-apple-darwin13.4.0' 'host_alias=arm64-apple-darwin20.0.0' 'CC=arm64-apple-darwin20.0.0-clang' 'CFLAGS=-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/mac/dev/pet/FindCorr/fc_env/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/postgresql-split_1701722081476/work=/usr/local/src/conda/postgresql-split-16.1 -fdebug-prefix-map=/Users/mac/dev/pet/FindCorr/fc_env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/mac/dev/pet/FindCorr/fc_env/lib -L/Users/mac/dev/pet/FindCorr/fc_env/lib' 'CPPFLAGS=-D_FORTIFY_SOURCE=2 -isystem /Users/mac/dev/pet/FindCorr/fc_env/include -mmacosx-version-min=11.0' 'CXX=arm64-apple-darwin20.0.0-clang++' 'CXXFLAGS=-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -fmessage-length=0 -isystem /Users/mac/dev/pet/FindCorr/fc_env/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/postgresql-split_1701722081476/work=/usr/local/src/conda/postgresql-split-16.1 -fdebug-prefix-map=/Users/mac/dev/pet/FindCorr/fc_env=/usr/local/src/conda-prefix' 'CLANG=arm64-apple-darwin20.0.0-clang' 'PKG_CONFIG_PATH=/Users/mac/dev/pet/FindCorr/fc_env/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.1 on aarch64-apple-darwin20.0.0, compiled by clang version 16.0.6, 64-bit"
